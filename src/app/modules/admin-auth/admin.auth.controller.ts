...
const loginWithCredential = asyncHandler(async (req: Request, res: Response) => {
  const result = await adminAuthService.loginWithCredential(req.body);
  sendResponse(res, {
...
const loginWithOAuth = asyncHandler(async (req: Request, res: Response) => {
  const result = await adminAuthService.loginWithOAuth(req.body);
  sendResponse(res, {
    statusCode: StatusCodes.OK,
    success: true,
    message: 'Welcome back! You have successfully logged in.',
...
const verifyEmailByOtp = asyncHandler(async (req: Request, res: Response) => {
  ...
  const result = await adminAuthService.verifyAccountByOtp(email, otp);
...
const sendVerificationOtpAgain = asyncHandler(async (req: Request, res: Response) => {
  ...
  const result = await adminAuthService.resendEmailVerificationOtpAgain(email);
...
const verifyResetPassword = asyncHandler(async (req: Request, res: Response) => {
  const { email, otp } = req.body;
  const result = await adminAuthService.verifyForgetPasswordByOtp(email, otp);
...
const sendResetPasswordOtpAgain = asyncHandler(async (req: Request, res: Response) => {
  const { email } = req.body;
  const result = await adminAuthService.resetPasswordOtpAgain(email);
...
const changePassword = asyncHandler(async (req: Request, res: Response) => {
  ...
  const result = await adminAuthService.changePassword(req.user, oldPassword, newPassword);
...
const getNewAccessTokenByRefreshToken = asyncHandler(async (req: Request, res: Response) => {
  ...
  const result = await adminAuthService.generateNewAccessTokenByRefreshToken(refreshToken);
